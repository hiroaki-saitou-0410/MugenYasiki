...
void InGameScene::Draw()
{
	...
	//}
	//
	//DrawFormatString(100, 120, GetColor(255, 255, 255), "左：%d < %d", 1400, player.GetPosX() + PlayerTexture_X);
	//DrawFormatString(100, 140, GetColor(255, 255, 255), "右：%d > %d", 1400 + 350, player.GetPosX());
	//
